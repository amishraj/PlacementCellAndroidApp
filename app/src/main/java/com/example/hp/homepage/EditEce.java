...
public class EditEce extends AppCompatActivity implements companyAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_ece);
    ...
    mycg = displayid.getText().toString(); */
        ...
        RecyclerView recyclerView = findViewById(R.id.editece_recycler);
    ...
    public void OnItemCLick(final DocumentSnapshot documentSnapshot, int position) {
        ...
        btnapply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(EditEce.this, "Showing Edit Company Page...", Toast.LENGTH_SHORT).show();
                GlobalClass globalClass= (GlobalClass) getApplicationContext();
                ...
                Intent i;
                i= new Intent(EditEce.this, EditHere.class); startActivity(i);
