...
public class EditChemical extends AppCompatActivity implements companyAdapter.OnItemClickListener{
    ...
    mycg = displayid.getText().toString(); */
        ...
        RecyclerView recyclerView = findViewById(R.id.editchemical_recycler);
    ...
    public void OnItemCLick(final DocumentSnapshot documentSnapshot, int position) {
        ...
        btnapply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(EditChemical.this, "Showing Edit Company Page...", Toast.LENGTH_SHORT).show();
                GlobalClass globalClass= (GlobalClass) getApplicationContext();
                ...
                Intent i;
                i= new Intent(EditChemical.this, EditHere.class); startActivity(i);
