...
public class ArchiCompanies extends AppCompatActivity implements companyAdapter.OnItemClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_archi_companies);
    ...
    mycg = displayid.getText().toString(); */
        ...
        RecyclerView recyclerView = findViewById(R.id.archicompanies_recycler);
    ...
    public void OnItemCLick(final DocumentSnapshot documentSnapshot, int position) {
        ...
        btnapply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(ArchiCompanies.this, "Showing Company Details...", Toast.LENGTH_SHORT).show();
                GlobalClass globalClass= (GlobalClass) getApplicationContext();
                ...
                Intent i;
                i= new Intent(ArchiCompanies.this, CompanyDetailsAdmin.class); startActivity(i);
