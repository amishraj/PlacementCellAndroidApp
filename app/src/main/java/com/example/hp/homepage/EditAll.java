...
public class EditAll extends AppCompatActivity implements companyAdapter.OnItemClickListener {
    ...
    public void setUpRecyclerView(){
        ...
        RecyclerView recyclerView = findViewById(R.id.editall_recycler);
    ...
    public void OnItemCLick(final DocumentSnapshot documentSnapshot, int position) {
        ...
        btnapply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(EditAll.this, "Showing Edit Company Page...", Toast.LENGTH_SHORT).show();
                GlobalClass globalClass= (GlobalClass) getApplicationContext();
                ...
                Intent i;
                i= new Intent(EditAll.this, EditHere.class); startActivity(i);
