...
public class ElectricalCompanies extends AppCompatActivity implements companyAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electrical_companies);
    ...
    mycg = displayid.getText().toString(); */
        ...
        RecyclerView recyclerView = findViewById(R.id.electricalcompanies_recycler);
    ...
    public void OnItemCLick(final DocumentSnapshot documentSnapshot, int position) {
        ...
        btnapply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(ElectricalCompanies.this, "Showing Company Details...", Toast.LENGTH_SHORT).show();
                GlobalClass globalClass= (GlobalClass) getApplicationContext();
                ...
                Intent i;
                i= new Intent(ElectricalCompanies.this, CompanyDetailsAdmin.class); startActivity(i);
